...
public class PannelloAggiungiAPietanza extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PannelloAggiungiAPietanza.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PannelloAggiungiAPietanza dialog = new PannelloAggiungiAPietanza(new javax.swing.JFrame(), true);
